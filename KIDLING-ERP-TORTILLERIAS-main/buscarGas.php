...
<html lang="es">
    ...
    <div class="main--content">
        ...
        <!-- Inicio de buscar inventario -->
        <div class="card">
            <div class="card-content">
                <div class="header-content">
                    <span class="barraB">BUSQUEDA INVENTARIO GAS</span>
                </div>
                <div class="row">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const loadResults = (fecha = '', turno = '') => {
                fetch(`fetchInventarioGas.php?fecha=${encodeURIComponent(fecha)}&turno=${encodeURIComponent(turno)}`)
            ...
            document.getElementById('registrarHarina').addEventListener('click', () => {
                ...
                const turno = document.getElementById('lista_categoria').value;
                loadResults(fecha, turno);
            });
